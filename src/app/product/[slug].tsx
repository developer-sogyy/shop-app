...
const ProductDetails = () => {
  ...
  const [quantity, setQuality] = useState(initialQuantity);
  ...
  const increaseQuantity = () => {
    if (quantity < product.maxQuantity) {
      ...
      toast.show(
        `Cannot add more than ${product.maxQuantity} items to the cart! Please remove some items first.`,
        {
          type: "warning",
          placement: "top",
          duration: 1500,
  ...
  const addToCart = () => {
    ...
    toast.show("Item added to the cart!", {
      type: "success",
      placement: "top",
      duration: 1500,
    });
